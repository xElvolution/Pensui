...
/**
 * Brand-accurate SVGs for the social icons we surface in the profile + dashboard.
 * Lucide v1.17 doesn't ship Twitter/GitHub marks; these are inline so we don't
 * add a dependency. Sized via className/width/height as usual.
 */
...
export function TwitterIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.66l-5.214-6.817-5.967 6.817H1.673l7.73-8.835L1.254 2.25h6.831l4.713 6.231 5.446-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z" />
    </svg>
  );
}
